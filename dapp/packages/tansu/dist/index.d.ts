...
export interface Client {
     ...
     */
    set_domain_contract: ({ admin, domain_contract }: {
        admin: string;
     ...
     */
    register: ({ maintainer, name, maintainers, url, ipfs, min_voting_period }: {
        maintainer: string;
        name: string;
        maintainers: Array<string>;
        url: string;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        build_commitments_from_votes: (json: string) => AssembledTransaction<Buffer[]>;
