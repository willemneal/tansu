 ...
 * `From`.
 */
export declare const NameError: {
    /**
     * Invalid name.
...
export interface Client {
     ...
     */
    vote: ({ voter, project_key, proposal_id, vote }: {
        voter: string;
        project_key: Buffer;
        proposal_id: u32;
        vote: Vote;
     ...
     * * If commitment
     */
    execute: ({ maintainer, project_key, proposal_id, tallies, seeds }: {
        maintainer: string;
        project_key: Buffer;
        proposal_id: u32;
        tallies: Option<Array<u128>>;
        seeds: Option<Array<u128>>;
    }, options?: MethodOptions) => Promise<AssembledTransaction<ProposalStatus>>;
    /**
     ...
     */
    get_dao: ({ project_key, page }: {
        project_key: Buffer;
        page: u32;
    }, options?: MethodOptions) => Promise<AssembledTransaction<Dao>>;
    /**
     ...
     */
    remove_vote: ({ maintainer, project_key, proposal_id, voter }: {
        maintainer: string;
        project_key: Buffer;
        proposal_id: u32;
        voter: string;
     ...
     * * If the proposal doesn't exist
     */
    get_proposal: ({ project_key, proposal_id }: {
        project_key: Buffer;
        proposal_id: u32;
     ...
     */
    create_proposal: ({ proposer, project_key, title, ipfs, voting_ends_at, public_voting, token_contract, outcome_contracts }: {
        proposer: string;
        project_key: Buffer;
        title: string;
        ipfs: string;
     ...
     * * If the maintainer is not authorized
     */
    revoke_proposal: ({ maintainer, project_key, proposal_id }: {
        maintainer: string;
        project_key: Buffer;
        proposal_id: u32;
    }, options?: MethodOptions) => Promise<AssembledTransaction<null>>;
     ...
     */
    anonymous_voting_setup: ({ maintainer, project_key, public_key }: {
        maintainer: string;
        project_key: Buffer;
        public_key: string;
    }, options?: MethodOptions) => Promise<AssembledTransaction<null>>;
     ...
     * * If the proposal is not active anymore
     */
    add_conflict_of_interest: ({ maintainer, project_key, proposal_id, addresses }: {
        maintainer: string;
        project_key: Buffer;
        proposal_id: u32;
     ...
     */
    get_conflict_of_interest: ({ project_key, proposal_id }: {
        project_key: Buffer;
        proposal_id: u32;
     ...
     * * If no anonymous voting configuration exists for the project
     */
    get_anonymous_voting_config: ({ project_key }: {
        project_key: Buffer;
    }, options?: MethodOptions) => Promise<AssembledTransaction<AnonymousVoteConfig>>;
    /**
     ...
     * * If the proposal is not active anymore
     */
    remove_conflict_of_interest: ({ maintainer, project_key, proposal_id, addresses }: {
        maintainer: string;
        project_key: Buffer;
        proposal_id: u32;
        addresses: Array<string>;
     ...
     */
    propose_upgrade: ({ admin, new_wasm_hash, new_admins_config }: {
        admin: string;
     ...
     */
    set_nqg_contract: ({ admin, nqg_contract, project }: {
        admin: string;
     ...
     */
    set_collateral_contract: ({ admin, collateral_contract }: {
        admin: string;
     ...
     */
    add_member: ({ member_address, meta }: {
    ...
    get_badges: ({ key }: {
        key: Buffer;
    }, options?: MethodOptions) => Promise<AssembledTransaction<Badges>>;
    /**
     ...
     */
    get_member: ({ member_address }: {
        member_address: string;
    }, options?: MethodOptions) => Promise<AssembledTransaction<Member>>;
    /**
     ...
     * * If the project doesn't exist
     */
    set_badges: ({ maintainer, key, member, badges }: {
        maintainer: string;
        key: Buffer;
        member: string;
        badges: Array<Badge>;
     ...
     * * If the member doesn't exist
     */
    update_member: ({ member_address, meta }: {
        member_address: string;
        meta: string;
    }, options?: MethodOptions) => Promise<AssembledTransaction<null>>;
    /**
     ...
     */
    get_max_weight: ({ project_key, member_address }: {
        project_key: Buffer;
        member_address: string;
    }, options?: MethodOptions) => Promise<AssembledTransaction<u32>>;
    /**
     ...
     * * If the maintainer is not authorized
     */
    commit: ({ maintainer, project_key, hash }: {
        maintainer: string;
        project_key: Buffer;
        hash: string;
    }, options?: MethodOptions) => Promise<AssembledTransaction<null>>;
     ...
     * `None`,
     */
    register: ({ maintainer, name, maintainers, url, ipfs, min_voting_period, execute_delay }: {
        maintainer: string;
        name: string;
        maintainers: Array<string>;
        url: string;
     ...
     * * If the maintainer is not authorized
     */
    update_config: ({ maintainer, key, maintainers, url, ipfs }: {
        maintainer: string;
        key: Buffer;
        maintainers: Array<string>;
        url: string;
     ...
     */
    set_sub_projects: ({ maintainer, project_key, sub_projects }: {
        maintainer: string;
        project_key: Buffer;
     ...
     */
    get_min_voting_period: ({ project_key }: {
        project_key: Buffer;
    }, options?: MethodOptions) => Promise<AssembledTransaction<u64>>;
}
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        get_anonymous_voting_config: (json: string) => AssembledTransaction<AnonymousVoteConfig>;
        remove_conflict_of_interest: (json: string) => AssembledTransaction<null>;
        build_commitments_from_votes: (json: string) => AssembledTransaction<Buffer<ArrayBufferLike>[]>;
        ...
        get_upgrade_proposal: (json: string) => AssembledTransaction<UpgradeProposal>;
        ...
        get_sub_projects: (json: string) => AssembledTransaction<Buffer<ArrayBufferLike>[]>;
